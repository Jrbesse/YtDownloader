...
/// <summary>
/// Persisted app-wide settings. Saved to settings.json under
/// <see cref="PlatformPaths.Current"/>.ConfigDir on every change.
///
...
public partial class AppSettings : ObservableObject
{
    ...
    private string SettingsPath =>
        _overridePath ?? Path.Combine(PlatformPaths.Current.ConfigDir, "settings.json");
